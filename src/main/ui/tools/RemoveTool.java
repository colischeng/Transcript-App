...
public class RemoveTool extends Tool {
    ...
    public RemoveTool(String label, String soundLocation, TranscriptApp transcriptApp, JTextArea textArea,
    ...
    public void doAction(TranscriptApp transcriptApp, JTextArea textArea, JTextField courseType, JTextField
        ...
        try {
            ...
            transcriptApp.getTranscript().getCourseList().remove(removeField - 1);
            textArea.setText(
    ...
    public JPanel createRemovalFields() {
        ...
        RemoveTool removeButton = new RemoveTool(this.label, this.soundLocation, this.transcriptApp, this.textArea,
