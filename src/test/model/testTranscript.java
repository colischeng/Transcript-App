...
class testTranscript {
    ...
    @BeforeEach
    void runBefore(){
        cpsc110 = new Course ("CPSC", 110, 2020, 90, 4);
        cpsc221 = new Course ("CPSC", 221, 2020, 85, 4);
        math221 = new Course ("MATH", 221, 2016, 90, 3);
        comm491 = new Course ("COMM", 491, 2019, 85, 3);
        math307 = new Course ("MATH", 307, 2017, 74, 3);
        cpsc121 = new Course ("CPSC", 121, 2020, 81, 4);
        engl112 = new Course ("ENGL", 112, 2015, 86, 3);
